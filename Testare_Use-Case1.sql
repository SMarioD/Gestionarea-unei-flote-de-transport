...
-- inputs 1 1 Bucuresti Constanta

SET SERVEROUTPUT ON;

-- Cerem utilizatorului să introducă valorile dorite
ACCEPT v_driver_id NUMBER PROMPT 'Introduceți ID-ul șoferului: ';
ACCEPT v_vehicle_id NUMBER PROMPT 'Introduceți ID-ul vehiculului: ';
ACCEPT v_route_start CHAR PROMPT 'Introduceți locația de plecare: ';
ACCEPT v_route_end CHAR PROMPT 'Introduceți locația de destinație: ';

DECLARE
    v_driver_id INT := &v_driver_id;  -- ID-ul șoferului introdus de utilizator
    v_vehicle_id INT := &v_vehicle_id;  -- ID-ul vehiculului introdus de utilizator
    v_route_start VARCHAR2(100) := '&v_route_start';  -- Locația de plecare introdusă de utilizator
    v_route_end VARCHAR2(100) := '&v_route_end';  -- Locația de destinație introdusă de utilizator
